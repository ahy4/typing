...
5. **複数の読み方がある漢字・単語は禁止**（タイピングゲームでは読みが一意に決まらないと打鍵列が確定できないため）
   - 禁止例（一部）: 良い（よい/いい）、今日（きょう/こんにち）、明日（あした/あす）、今朝（けさ/こんちょう）、大人（おとな/たいじん）、一日（いちにち/ついたち）、二日（ふつか/ふたひ）、上手（じょうず/うわて）、下手（へた/したて）、人気（にんき/ひとけ）、日本（にほん/にっぽん）、一人（ひとり/いちにん）、二人（ふたり/ににん）、白髪（しらが/はくはつ）、建物（たてもの/たちもの）
...
2. **漢字の読み**: jp の漢字が正しいひらがな読みで kana に含まれているか
   - 特に**促音便**（っ）に注意：熟語・複合語では「つ」が「っ」に変わる
...
6. **複数読み漢字の禁止**: jp に複数の読み方がある漢字・単語が含まれていれば `valid: false` にする
   - タイピングゲームでは読みが一意でないと正解の打鍵列が確定できないため、これらは使用禁止
   - 禁止の代表例: 良い（よい/いい）、今日（きょう/こんにち）、明日（あした/あす）、今朝（けさ/こんちょう）、大人（おとな/たいじん）、一日（いちにち/ついたち）、二日（ふつか/ふたひ）、上手（じょうず/うわて）、下手（へた/したて）、人気（にんき/ひとけ）、日本（にほん/にっぽん）、一人（ひとり/いちにん）、二人（ふたり/ににん）、白髪（しらが/はくはつ）、建物（たてもの/たちもの）
   - 上記リストに限らず、文脈によらず読みが一意に定まらない漢字・単語を含む文は除外する
