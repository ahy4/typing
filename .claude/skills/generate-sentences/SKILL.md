...
5. **標準的な読み方が2つある漢字・単語は禁止**（タイピングゲームでは読みが一意に決まらないと打鍵列が確定できないため）
   - 禁止例（一部）: 良い（よい/いい）、日本（にほん/にっぽん）、明日（あした/あす）、一日（いちにち/ついたち）、上手（じょうず/うわて）、下手（へた/したて）、人気（にんき/ひとけ）、白髪（しらが/はくはつ）
...
6. **標準的な読み方が2つある漢字・単語の禁止**: jp にそのような漢字・単語が含まれていれば `valid: false` にする
   ...
   - 禁止の代表例: 良い（よい/いい）、日本（にほん/にっぽん）、明日（あした/あす）、一日（いちにち/ついたち）、上手（じょうず/うわて）、下手（へた/したて）、人気（にんき/ひとけ）、白髪（しらが/はくはつ）
