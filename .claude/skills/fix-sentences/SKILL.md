...
```bash
git add src/lib/sentences.toml src/lib/generated/sentences.json .claude/agents/sentence-generator.md .claude/skills/generate-sentences/validate-prompt.md
