---
name: fix-sentences
description: ユーザーが提示したNG例・NG理由にもとづいて、sentences.tomlの既存データを削除し、generate-sentences スキルの生成・検証プロンプトに同種のミスを防ぐルールを追記する。
---
...
1. `src/lib/sentences.toml` 内の該当エントリを削除する
